        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Planes Turisticos</h4>
                    <p class="text-muted">Puedes aramar tu plan turistico como quieras, desde todo incluido (sujeto a condiciones), hasta solo la estadia en el hotel a destinos nacionales e internacionales.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                ...
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Hacemos convenios con empresas, para que los empleados tengan un descuento especial.</p>
                </div>                
            </div>
            <div class="row text-center">
                <div class="col-md-4">
...
<!--                     <span class="fa-stack fa-4x">
                    ...
                    <h4 class="service-heading">Cruceros</h4>
