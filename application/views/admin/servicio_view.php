        ...
        <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <!-- FORM SERVICIO -->
                    <form class="form-horizontal form-label-left"  method="post" action="<?= base_url(''); ?>/admin/Servicio/guardarServicio" novalidate>
                    <!--
                      <p>For alternative validation library <code>parsleyJS</code> check out in the <a href="form.html">form page</a>
                      </p>
                      -->
                      <span class="section">Vista de servicio</span>
                      <?php 
                        if(!is_null($datosCarga)){
                          echo '<input type="text" id="id" name="id" value="'.$datosCarga[0]->servicio_id .'" hidden="true">';
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="Nombre" class="form-control col-md-7 col-xs-12" name="icono" placeholder="" required="required" type="text" data-validation-length="3-12" data-validation-error-msg="User name has to be an alphanumeric value (3-12 chars)" value="<?php echo (!is_null($datosCarga)) ? $datosCarga[0]->servicio_icono : '' ;?>">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="profesion" class="form-control col-md-7 col-xs-12" name="titulo" placeholder="" required="required" type="text" data-validation-length="3-12" data-validation-error-msg="User name has to be an alphanumeric value (3-12 chars)" value="<?php echo (!is_null($datosCarga)) ? $datosCarga[0]->servicio_titulo : '' ;?>">
                        </div>
                      </div>
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Link">Descripción</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="x_content">
                            ...
                            <div id="editor" class="editor-wrapper"><?php echo (!is_null($datosCarga)) ? $datosCarga[0]->servicio_contenido : '' ;?></div>                 
                          </div>
                          </div>
                      </div>
                      <div class="item form-group">
                          ...
                          <table id="datatable-keytable" class="table table-striped table-bordered">
                            ...
                            if($Slide != NULL){ 
                              foreach ($Slide as $key) {
                                echo '<tr>';
                                  echo '<td><i class="fa '.$key->servicio_icono.'"></i></td>';
                                  echo '<td>'.$key->servicio_titulo.'</td>';
                                  echo '<td>'.$key->servicio_contenido.'</td>';
                                  if ($key->estado_id == 1) {
                                    echo "<td>activo</td>";
                                  }
                                  else
                                  ...
                                  echo '<td><center><a href="'.base_url().'admin/Servicio/index/'.$key->servicio_id.'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i> Editar</a></center></td>';
                                echo '</tr>';
                              }
                              }else{
                                    echo '<tr>';
