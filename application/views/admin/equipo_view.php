                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!--
                      ...
                      -->
                      <span class="section">AGREGAR ASESOR</span>
                      <?php 
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="URL" name="URL" required="required" placeholder="" class="form-control col-md-7 col-xs-12" readonly="readonly" value="<?php echo (!is_null($datosCarga)) ? $datosCarga[0]->equipo_imagen : '' ;?>">
                      ...
                      <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Link">Ocupación</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="x_content">
                            <div id="alerts"></div>
                            ...
                            <div id="editor" class="editor-wrapper"><?php echo (!is_null($datosCarga)) ? $datosCarga[0]->equipo_ocupacion : '' ;?></div>                 
                          </div>
                          </div>
                      </div>
                      <div class="item form-group">
                            ...
                            if($Slide != NULL){ 
                              foreach ($Slide as $key) {
                                echo '<tr>';
                                  ...
                                  echo '<td><img src="'.base_url('file/img').'/'.$key->equipo_imagen.'" height="42" width="42"></td>';
                                  echo '<td>'.$key->equipo_ocupacion.'</td>';
                                  if ($key->estado_id == 1) {
                                    echo "<td>activo</td>";
                                  }
                                  else
                                  ...
                                  echo '<td><center><a href="'.base_url().'admin/Equipo/index/'.$key->equipo_id.'"><i class="fa fa-pencil fa-2x" aria-hidden="true"></i> Editar</a></center></td>';
                                echo '</tr>';
                              }
                              }else{
                                    echo '<tr>';
